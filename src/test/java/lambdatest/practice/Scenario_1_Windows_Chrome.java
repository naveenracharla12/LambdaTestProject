...
public class Scenario_1_Windows_Chrome {
	...
	public void setUp() {
		...
		caps.setCapability("build", "TestDemo Windows Chrome");
		caps.setCapability("name", "Windows 11 and Chrome 86.0");
		...
		try
        {
            driver = new RemoteWebDriver(new URL("https://" + "naveen.racharla" + ":" + "" + "@hub.lambdatest.com/wd/hub"), caps);
        }
